...
export default function ConfigPanel({ onToneOfVoice, tone }) {
  ...
  return (
    <div className="bg-tinted-white-blue rounded-xl shadow-md p-4 h-[42vh] grow shrink-0 flex flex-col justify-between">
      ...
      {/* <div className="w-full h-9 rounded-lg bg-natural-white p-2 no-scrollbar border-1 border-primary-blue">
        <textarea
          name="content"
          id=""
